    ...
    return (
        <ul className={styles.navbar__list}>
          ...
          <li>
            ...
            <Link className={pathname === '/settings' ? styles.active : ''} to='/settings'>Settings</Link>
          </li>
          <li>
            <svg className="w-[25px] h-[25px] text-gray-800 dark:text-white" aria-hidden="true"
                 xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link className={pathname === '/playgraund' ? styles.active : ''} to='/playgraund'>Playgraund</Link>
          </li>
        </ul>
    );
}
